(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [9036], {
        ...
        8471: function(e, t, n) {
            ...
            t.Element = m, t.isTag = y, t.isCDATA = g, t.isText = v, t.isComment = b, t.isDirective = E, t.isDocument = x, t.hasChildren = function(e) {
        ...
        15426: function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                switch (h) {
                    case o:
                        var m = p(e);
                        if (!c.test(e)) {
                            var y = m.querySelector(a);
                            null === (t = null == y ? void 0 : y.parentNode) || void 0 === t || t.removeChild(y)
                        }
                        if (!u.test(e)) {
                            var y = m.querySelector(l);
                            null === (n = null == y ? void 0 : y.parentNode) || void 0 === n || n.removeChild(y)
                        }
                        return m.querySelectorAll(o);
                    case a:
                    case l:
                        var g = d(e).querySelectorAll(h);
                        if (u.test(e) && c.test(e)) return g[0].parentNode.childNodes;
                        return g;
                    default:
                        if (r) return r(e);
                        var y = d(e, l).querySelector(l);
                        return y.childNodes
                }
            };
            var r, i = n(56373),
            ...
            var y = "object" == typeof document && document.createElement("template");
            y && y.content && (r = function(e) {
        ...
        56373: function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                void 0 === n && (n = null);
                for (var s, c = [], u = 0, d = t.length; u < d; u++) {
                    var p = t[u];
                    switch (p.nodeType) {
                        case 1:
                            var f = function(e) {
                            ...
                            (s = new r.Element(f, o(p.attributes))).children = e("template" === f ? p.content.childNodes : p.childNodes, s);
                            break;
                        case 3:
                            s = new r.Text(a(p.nodeValue));
                            break;
                        case 8:
                            s = new r.Comment(p.nodeValue);
                            break;
                        default:
                            continue
                    }
        ...
        49455: function(e, t, n) {
            ...
            } = n(46626), u = RegExp.prototype.test.bind(RegExp("^(data|aria)-[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$")), d = Object.keys(c).reduce((e, t) => {
                let n = c[t];
        ...
        39036: function(e, t, n) {
            ...
            var r = n(57437),
                ...
                d = n(35527),
                p = n(3795);
            let f = a()(() => Promise.all([n.e(3708), n.e(4158), n.e(6914)]).then(n.bind(n, 46914)).then(e => ({
                default: e.BootstrapStyles
            })), {
                loadableGenerated: {
                    webpack: () => [require.resolveWeak("./BootstrapStyles.js")]
                }
            });
            ...
            function h(e) {
                let {
                    ...
                    entryId: n,
                    ad_type: o
                } = e, [a, s] = (0, u.useState)(!1), {
                    deliveryLocation: h
                } = (0, d.$)();
                if ((0, u.useEffect)(() => {
                        s(!0)
                    }, []), !t) return null;
                let m = "undefined" != typeof window ? i.sanitize(t, {
                    ADD_TAGS: ["link", "script"],
                    FORCE_BODY: !0
                }) : "";
                return a ? (0, r.jsxs)(p.CostcoBox, {
                    className: "with-bootstrap",
                    "data-testid": "".concat("RichTextEntry", "-").concat(n),
                    "data-layout": o ? "".concat("rich_text_").concat(o) : null,
                    children: [(0, r.jsx)(f, {}), c(m, {
                        replace: function(e, t) {
                            var i, o, a, s, c, u;
                            if ("tag" === e.type && (null == (o = null == (i = null == e ? void 0 : e.attribs) ? void 0 : i.href) ? void 0 : o.includes(l.ZI)) && (e.attribs.href = e.attribs.href.replace(l.$Y, l.$Y + h.zipCode)), "script" === e.type) {
                                let i = e.attribs.id || "".concat(n, "_").concat(t),
                                    o = document.createElement("script");
                                return o.id = i, e.attribs.type && (o.type = e.attribs.type), e.attribs.src && (o.src = e.attribs.src), (null == (s = null == (a = null == e ? void 0 : e.children) ? void 0 : a[0]) ? void 0 : s.data) && (o.textContent = "".concat(null == (u = null == (c = null == e ? void 0 : e.children) ? void 0 : c[0]) ? void 0 : u.data)), setTimeout(() => {
                                    try {
                                        let e = document.getElementById(i);
                                        e && document.head.removeChild(e), document.head.appendChild(o)
                                    } catch (e) {}
                                }), (0, r.jsx)(r.Fragment, {})
                            }
                        }
